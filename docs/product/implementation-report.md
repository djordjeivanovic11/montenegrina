...
- Google-only authentication with copyable team invitation links
...
6. Enable `BILLING_ENABLED` and configure Google OAuth production origins for paying customers
